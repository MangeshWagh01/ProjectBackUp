        ...
        <div className="collapse navbar-collapse" id="navbarNav">
          <ul className="navbar-nav ml-auto">
            <li className="nav-item active">
              <NavLink className="nav-link" to="/farmer-dash">Farmer <span className="sr-only">(current)</span></NavLink>
            </li>
            <li className="nav-item">
              <NavLink className="nav-link" to="/marketRate">Market Rate</NavLink>
            </li>
            <li className="nav-item">
            ...
            {isLoggedIn ? (
              <li className="nav-item">
                <NavLink className="nav-link" to="/securelogin" onClick={logout}>Logout</NavLink>
              </li>
            ) : (
              <li className="nav-item">
                <NavLink className="nav-link" to="/securelogin">Login</NavLink>
              </li>
            )}
          </ul>
        </div>
